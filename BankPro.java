...
------------------------------------------------------------------------------------------------------------------------------------------------------------
create table Bankdetails("NAME" varchar(50),"B-PIN" varchar(15),"FATHER_NAME" varchar(50),"DOB" varchar(15),"EMAIL" varchar(100),"ADDRESS" varchar(100),"CITY" varchar(20),"PIN_CODE" varchar(20),"STATE" varchar(20),"AADHAR" varchar(25),"PAN_NO" varchar(30),"INCOME" varchar(20),"CARD_NO" varchar(50))
*/
}
catch(Exception e){
